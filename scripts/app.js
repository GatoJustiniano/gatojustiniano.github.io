function init() {
  ...
  const linkNames = ['top','acerca', 'proyectos', 'experiencia', 'contacto']
  ...
  window.onload = function() {
    ...
    setTimeout(()=>{
      ...
      triggerShuffle(title, 'Alvaro Andres Justiniano Herrera', 4)
      triggerShuffle(intro, 'desarrollador web', 4)

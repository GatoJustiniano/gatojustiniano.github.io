...
function MPtarjeta(){
    ...
    let html = `
        <div class="col-6 form-group">
            ...
            <input id="montoTarjeta" class="form-control" onkeyup="ValidacionMetodoPago()" type="number" step="0.01" min="0" max="1000000" value="0" />
        </div>`
...
function MPcheque(){
    ...
    let html = `
        <div class="col-lg-6 form-group">
            ...
            <input id="montoCheque" class="form-control" onkeyup="ValidacionMetodoPago()" type="number" step="0.01" min="0" max="1000000" value="0" />
        </div>`
    $("#html_montos_metodos_de_pago").append(html);
}
...
function MPefectivo(){
    ...
    <div class="col-6 form-group">
        ...
        <input id="montoEfectivo" class="form-control" onkeyup="ValidacionMetodoPago();" type="number" step="0.01" min="0" max="1000000" value="0" />
    </div>
    <div class="col-6 form-group">
...
function MPvale(){
    let html = `<div class="col-6 form-group">
        ...
        <input id="montoVale" type="number" class="form-control" onkeyup="ValidacionMetodoPago()" step="0.01" min="0" max="1000000" value="0" />
    </div>`
    $("#html_montos_metodos_de_pago").append(html);
}
...
function MPotros(){
    let html = `<div class="col-6 form-group">
        ...
        <input id="montoOtros" type="number" step="0.01" class="form-control" onkeyup="ValidacionMetodoPago()" min="0" max="1000000" value="0" />
    </div>`
    $("#html_montos_metodos_de_pago").append(html);
}
...
function MPpagoPosterior(){
    let html = `<div class="col-6 form-group">
        ...
        <input id="montoPagoPosterior" type="number" step="0.01" onkeyup="ValidacionMetodoPago()" class="form-control" min="0" max="1000000" value="0" />
    </div>`
    $("#html_montos_metodos_de_pago").append(html);
}
...
function MPtransferenciaBancaria(){
    let html = `<div class="col-6 form-group">
        ...
        <input id="montoTransferenciaBancaria" type="number" step="0.01" onkeyup="ValidacionMetodoPago()" class="form-control" min="0" max="1000000" value="0" />
    </div>`
    $("#html_montos_metodos_de_pago").append(html);
}
...
function MPdepositoCuenta(){
    let html = `<div class="col-6 form-group">
        ...
        <input id="montoDepositoCuenta" type="number" step="0.01" onkeyup="ValidacionMetodoPago()" class="form-control" min="0" max="1000000" value="0" />
    </div>`
    $("#html_montos_metodos_de_pago").append(html);
}
...
function MPtransferenciaSwift(){
    ...
    <div class="col-6 form-group">
        ...
        <input id="montoSwift" type="number" step="0.01" onkeyup="ValidacionMetodoPago()" class="form-control" min="0" max="1000000" value="0" />
    </div>`;
    $("#html_montos_metodos_de_pago").append(html);
}
...
function MPcanalPago(){
    ...
    <div class="col-6 form-group">
        ...
        <input id="montoCanalPago" type="number" step="0.01" onkeyup="ValidacionMetodoPago()" class="form-control" min="0" max="1000000" value="0" />
    </div>`;
    $("#html_montos_metodos_de_pago").append(html);
}
...
function MPbilleteraMovil(){
    ...
    <div class="col-6 form-group">
        <label>Monto Canal de Pago</label>
        <input id="montoBilleteraMovil" type="number" step="0.01" onkeyup="ValidacionMetodoPago()" class="form-control" min="0" max="1000000" value="0" />
    </div>`;
    $("#html_montos_metodos_de_pago").append(html);
}
...
function MPpagoOnline(){
    ...
    <div class="col-6 form-group">
        <label>Monto Canal de Pago</label>
        <input id="montoPagoOnline" type="number" step="0.01" onkeyup="ValidacionMetodoPago()" class="form-control" min="0" max="1000000" value="0" />
    </div>`;
    $("#html_montos_metodos_de_pago").append(html);
}
